/**
 * @fileoverview 首页看板：任务 / 报告 / 人事（人才池）三 Tab；报告 Tab 切换时刷新 `loadExtractionHistory`。
 *
 * @module Dashboard
 */
...
type HomeBoardTab = "tasks" | "reports" | "hr";

/** 默认落地页「看板」；任务、报告、人事三 Tab。 */
export function Dashboard() {
  ...
  const byCategory = (cat: string) => {
    ...
    return { subset, completed, overdue, ongoing, solid, stuck };
  };
      ...
      <div className="dash-main">
        ...
        <section className="category-row">
          {TASK_CATEGORY_LEVEL1_LIST.map((cat) => {
            ...
            const { subset, completed, overdue, ongoing, solid, stuck } = byCategory(cat);
              ...
              <div key={cat} className="card cat-card">
                ...
                <Donut
                  segments={[
                    ...
                    { label: "实质性进展", value: solid, color: "#2563eb" },
